...
public class CustomerControllerTest {
    ...
    public void getCustomer() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customer/" + validCustomer.getId().toString()).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.name", is("Haydar")));
    }
    ...
    public void handlePost() throws Exception {
        ...
        CustomerDto savedDto = CustomerDto.builder().id(UUID.randomUUID()).name("Haydar").build();
        String customerDtoJson = objectMapper.writeValueAsString(customerDto);

        given(customerService.createNewCustomer(any())).willReturn(savedDto);
